let c = init("canvas").c,
  ...
  last_mouse = {};
let pageEl = document.documentElement || document.body
let that
let Time = function (e) {
  last_mouse.x = mouse.x;
  last_mouse.y = mouse.y;
  mouse.x = that.pageX - this.offsetLeft;
  mouse.y = that.pageY - this.offsetTop;
}
...
pageEl.addEventListener("mouseleave", function (e) {
  mouse.x = false;
  mouse.y = false;
});
